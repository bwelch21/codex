      ...
      >
        ...
        >
          ...
          >
            ...
            Our system will extract text and identify potential allergens in
            menu items.
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                <li>
                  Size:{" "}
                  {(uploadState.uploadedFile.file.size / 1024 / 1024).toFixed(
                    2,
                  )}{" "}
                  MB
                </li>
                ...
                <li>
                  Uploaded:{" "}
                  {new Date(
                    uploadState.uploadedFile.file.uploadedAt,
                  ).toLocaleString()}
                </li>
              </ul>
            </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  {photoState.file
                    ? (photoState.file.size / 1024 / 1024).toFixed(2) + " MB"
                    : "N/A"}
                </p>
              </div>
              ...
              <div>
                ...
                <p
                  style={{
                    fontSize: theme.typography.fontSize.base,
                    color: photoState.isUploaded
                      ? theme.colors.success[600]
                      : theme.colors.neutral[900],
                    fontWeight: photoState.isUploaded
                      ? theme.typography.fontWeight.medium
                      : theme.typography.fontWeight.normal,
                  }}
                >
                  {photoState.isUploaded
                    ? "✓ Ready for Analysis"
                    : "No file selected"}
                </p>
              </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Drag and drop your menu image, click to browse files, or use
                  the camera button on mobile devices to take a photo.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  Upload PNG, JPEG, or PDF files up to 10MB. Images will show a
                  preview, while PDFs will display a file icon.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  Once uploaded, click "Analyze Menu" to send your image to our
                  server for processing. You'll see a progress bar during upload
                  and analysis.
                </p>
              </div>
            </div>
